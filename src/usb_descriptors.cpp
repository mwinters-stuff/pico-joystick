...
// array of pointer to string descriptors
  char const* string_desc_arr [] =
  {
    ...
    "Winters",                 // 1: Manufacturer
    "JoyFunStick",             // 2: Product
    "Rpi Pico",             // 3: Serials, should use chip ID
    "JoyFunStick Serial",          // 4: CDC Interface
  };
...
uint16_t const* tud_descriptor_string_cb(uint8_t index, uint16_t langid)
{
  ...
  // memcpy(id, string_desc_arr[3] , PICO_UNIQUE_BOARD_ID_SIZE_BYTES);
